...
do
	rm -rf "R${r}"
	python $compute --model_path $PROJECT_ROOT/from_C2_v1/MACE.model --device cuda --fmax 1e-5 --threshold 0.0015 --nstrains 91 --min_strain 0 --max_strain 0.30 --outdir "R${r}" --rot $r  --convergence_threshold 1e-8
