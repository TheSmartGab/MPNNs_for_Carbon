...
do
	rm -rf "R${r}"
	python $compute --model_path $PROJECT_ROOT/from_C2_v1/MACE.model --device cuda --fmax 1e-5 --threshold 0.0015 --nstrains 91 --min_strain -0.1 --max_strain 0 --outdir "R${r}" --rot $r --compression --convergence_threshold 1e-8
